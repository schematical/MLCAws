...
class AWSInstanceBase extends BaseEntity {
    ...
    public function __toArray() {
        ...
        $arrReturn['ip_address'] = $this->ip_address;
    ...
    public function __get($strName) {
        switch ($strName) {
            ...
            case ('Ip_address'):
            case ('ip_address'):
                if (array_key_exists('ip_address', $this->arrDBFields)) {
                    return $this->arrDBFields['ip_address'];
                }
                return null;
            break;
            case ('CreDate'):
        ...
        public function __set($strName, $strValue) {
            ...
            switch ($strName) {
                ...
                case ('Ip_address'):
                case ('ip_address'):
                    $this->arrDBFields['ip_address'] = $strValue;
                break;
                case ('CreDate'):
                case ('creDate'):
